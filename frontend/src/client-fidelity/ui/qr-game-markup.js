...
export function renderQrGamePage(esc, p) {
  ...
  return `
    ...
    <div id="fidelity-qr-modal-root" class="fidelity-qr-modal-root hidden" aria-hidden="true">
      ...
      <div id="fidelity-qr-panel-google" class="fidelity-qr-modal fidelity-qr-modal--google" role="dialog" aria-modal="true" aria-labelledby="fidelity-qr-google-title">
    ...
    <footer class="fidelity-v2-footer fidelity-qr-powered">

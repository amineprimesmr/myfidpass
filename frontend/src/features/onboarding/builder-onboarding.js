...
<div class="builder-onboarding-logo-drop-zone" id="builder-onboarding-logo-drop-zone" role="button" tabindex="0" aria-label="Glisser-déposer une image, cliquer ou coller (Ctrl+V)">
  ...
  <label for="builder-onboarding-logo-input" class="builder-onboarding-logo-label">
    ...
    if (hasAccountForm) {
      ...
      const socialBlock = (googleClientId || appleClientId) ? `<div class="builder-onboarding-account-social-row">${googleClientId ? `<div id="builder-onboarding-google-btn" class="landing-onboarding-google-wrap"></div>` : ""}${appleClientId ? `<button type="button" id="builder-onboarding-apple-btn" class="landing-onboarding-btn-apple" aria-label="Continuer avec Apple"><span class="landing-onboarding-apple-icon" aria-hidden="true"></span>Continuer avec Apple</button>` : ""}</div>` : "";
      const emailBlock = `<p class="landing-onboarding-account-divider">Ou avec votre e-mail</p><label for="builder-onboarding-email" class="landing-onboarding-account-label">Email</label><input type="email" id="builder-onboarding-email" class="landing-onboarding-account-input" placeholder="vous@exemple.fr" autocomplete="email" /><label for="builder-onboarding-password" class="landing-onboarding-account-label">Mot de passe (8 caractères min.)</label><input type="password" id="builder-onboarding-password" class="landing-onboarding-account-input" placeholder="••••••••" autocomplete="new-password" minlength="8" /><button type="button" id="builder-onboarding-register-btn" class="builder-onboarding-btn builder-onboarding-btn-primary">Créer mon compte</button>`;

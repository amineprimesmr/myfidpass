...
async function bootstrap() {
  ...
  try {
    ...
    document.body.innerHTML = `
      <div style="font-family: Inter, system-ui, sans-serif; max-width: 32rem; margin: 2rem auto; padding: 1.5rem; background: #fef2f2; border: 1px solid #fecaca; border-radius: 8px;">

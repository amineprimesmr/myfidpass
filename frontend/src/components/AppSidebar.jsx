    ...
    <Sidebar>
      <DesktopSidebar>
          ...
          <div className="app-sidebar-footer border-t border-[var(--app-sidebar-border)] px-5 py-4">
            ...
            <button type="button" id="app-logout" className="visually-hidden" tabIndex={-1} aria-hidden="true">
              Déconnexion
            </button>
            <a
              href="#profil"
              data-section="profil"
              className={`app-sidebar-link app-sidebar-footer-settings ${activeSection === "profil" ? "app-sidebar-link-active" : ""}`}
            >
              <span className="app-sidebar-icon" aria-hidden="true">
                <IconSettings />
              </span>
              <span className="app-sidebar-link-text">Paramètres</span>
            </a>
          </div>
      </DesktopSidebar>
    </Sidebar>

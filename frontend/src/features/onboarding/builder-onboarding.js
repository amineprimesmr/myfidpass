...
<div class="builder-onboarding-logo-drop-zone" id="builder-onboarding-logo-drop-zone" role="button" tabindex="0" aria-label="Glisser-déposer une image, cliquer ou coller (Ctrl+V)">
  ...
  <label for="builder-onboarding-logo-input" class="builder-onboarding-logo-label">
    ...
    if (hasAccountForm) {
      ...
      const socialBlock = hasSocial ? `<div class="builder-onboarding-account-social-row">${googleClientId ? `<div id="builder-onboarding-google-btn" class="landing-onboarding-google-wrap"></div>` : ""}${appleClientId ? `<button type="button" id="builder-onboarding-apple-btn" class="landing-onboarding-btn-apple" aria-label="Continuer avec Apple"><span class="landing-onboarding-apple-icon" aria-hidden="true"></span>Continuer avec Apple</button>` : ""}</div>` : "";
      const emailDivider = hasSocial ? `<p class="landing-onboarding-account-divider">Ou avec votre e-mail</p>` : "";
